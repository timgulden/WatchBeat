...
3. **Pipeline stages**: 8 kHz highpass (pre-filter) -> Envelope FFT (rate identification) -> Try-all-rates with guided tick extraction -> Linear regression -> MeasurementResult
