...
final class PeriodEstimatorTests: XCTestCase {
    ...
    func testDetects19800bph() {
        let result = estimateRate(beatRate: .bph19800)
        XCTAssertEqual(result.snappedRate, .bph19800)
        XCTAssertEqual(result.measuredHz, 5.5, accuracy: 0.1)
    }
